...
public class ReadBookActivity extends Activity implements AdapterView.OnItemClickListener,
        InterClick {
    ...
    private void dialogEditComment() {
        ...
        builder.setPositiveButton("保存", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(ReadBookActivity.this, editText.getText().toString() + "  发送成功！", Toast.LENGTH_LONG).show();
