...
public class ReportDetailAdapter  extends BaseAdapter  {
    ...
    public ReportDetailAdapter(Context context, List<String> contentList,
                           InterClick callback) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.i(TAG, "getView");
        ReportDetailAdapter.ViewHolder holder = null;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.report_detail_item, null);
            holder = new ReportDetailAdapter.ViewHolder();
...
//            holder.button2 = (Button) convertView.findViewById(R.id.ban);
            ...
            holder = (ReportDetailAdapter.ViewHolder) convertView.getTag();
        }
